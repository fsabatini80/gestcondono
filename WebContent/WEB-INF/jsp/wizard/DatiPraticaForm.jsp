...
<div class="ui-tabs-panel ui-widget-content ui-corner-bottom">
	...
	<form:form action="salvaPratica.htm"
		...
		<table>
			<tr>
				...
				<td><form:input path="numeroPratica" /><form:hidden path="iddatipratica" /></td>
				<td><form:errors path="numeroPratica" cssClass="ui-state-error" /></td>
			</tr>
			<tr>
				<td>Legge condono *:</td>
				<td><form:select path="leggeCondono" items="${leggiList}">
					</form:select></td>
		...
		<div class="ui-widget-content ui-corner-all">
				<table>
					...
					<tr class="ui-widget-content">
						...
						<td><form:select path="statoEsteroNas"
								items="${provinceList}" /></td>
					</tr>
					<tr class="ui-widget-content">
		...
		<!-- table>
			<tr>
				<td colspan="3"><input type="submit" value="avanti"
					name="_target1" /> <input type="submit" value="esci"
					name="_cancel" /></td>
			</tr>
		</table>-->

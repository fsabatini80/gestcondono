...
public class PraticheController extends BaseController {
	...
	this.oneriConcessoris = oneriConcessoriHome.findAllDistinct();
	// List<OneriConcessori> zoneUrbanistiche = new
	// ArrayList<OneriConcessori>();
	// String cu = "";
